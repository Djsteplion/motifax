...
export default function Scanner() {
  ...
  const handleFileChange = async (e: ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onloadend = async () => {
      ...
      // Keep using the Base64 data for the preview
      setPreview(base64)

      try {
        // Send the actual image data, NOT a blob URL
        ...
        setResult('Unable to analyze this image. Please try again.')
      } finally {
        setIsLoading(false)
      }
    }
  ...
  return (
    <div className="max-w-xl mx-auto">
      ...
      {/* Results Display */}
      {result && (
        <div className="mt-8 p-8 bg-white border border-gray-200 rounded-3xl text-left shadow-xl animate-in fade-in slide-in-from-bottom-4">
